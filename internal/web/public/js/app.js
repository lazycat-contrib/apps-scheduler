...
const i18n = {
  zh: {
    ...
    mcp_tokens: 'MCP 访问 Token',
    mcp_token_name: 'Token 名称',
    mcp_token_name_placeholder: '例如：桌面客户端',
    mcp_token_hint: 'Token 只会在创建时显示一次，用于外部 MCP 客户端以 Bearer token 访问 /mcp。',
    mcp_lazycat_hint: '懒猫应用间调用请使用',
    mcp_lazycat_ticket_hint: '并转发当前用户的 X-HC-USER-TICKET。',
    create_token: '创建 Token',
    existing_tokens: '已有 Token',
    new_token_once: '新 Token 只显示一次',
    no_tokens: '暂无 Token',
    created_at: '创建',
    last_used: '最近使用',
    never_used: '从未使用',
    ...
    token_revoke_failed: 'Token 撤销失败',
    confirm_revoke_token: '确定要撤销这个 Token 吗？',
    copied: '已复制',
  ...
  en: {
    ...
    mcp_tokens: 'MCP Access Tokens',
    mcp_token_name: 'Token Name',
    mcp_token_name_placeholder: 'e.g., Desktop client',
    mcp_token_hint: 'Tokens are shown only once when created and let external MCP clients access /mcp with a Bearer token.',
    mcp_lazycat_hint: 'For LazyCat app-to-app calls, use',
    mcp_lazycat_ticket_hint: 'and forward the current user X-HC-USER-TICKET.',
    create_token: 'Create Token',
    existing_tokens: 'Existing Tokens',
    new_token_once: 'New token shown once',
    ...
    copied: 'Copied',
    copy_failed: 'Copy failed; copy it manually',
  ...
  ja: {
    ...
    mcp_token_name: 'トークン名',
    mcp_token_name_placeholder: '例：デスクトップクライアント',
    mcp_token_hint: 'トークンは作成時に一度だけ表示され、外部 MCP クライアントが Bearer token で /mcp にアクセスするために使います。',
    mcp_lazycat_hint: 'LazyCat アプリ間呼び出しは',
    mcp_lazycat_ticket_hint: 'を使い、現在ユーザーの X-HC-USER-TICKET を転送してください。',
    create_token: 'トークン作成',
    existing_tokens: '既存トークン',
    new_token_once: '新しいトークンは一度だけ表示されます',
    no_tokens: 'トークンはありません',
    created_at: '作成',
    last_used: '最終使用',
    never_used: '未使用',
    revoked: '取り消し済み',
    ...
    token_create_failed: 'トークン作成に失敗しました',
    token_revoked: 'トークンを取り消しました',
    token_revoke_failed: 'トークン取り消しに失敗しました',
    confirm_revoke_token: 'このトークンを取り消しますか？',
    copied: 'コピーしました',
